import type { NEREntity, NLPAction, NLPDomain, NLPSkill, NLPUtterance, NLUResolver, NLUResult, NLUSlot, NLUSlots } from '../nlp/types';
import type { SkillConfigSchema, SkillAnswerConfigSchema } from '../../schemas/skill-schemas';
...
export declare enum SkillBridges {
    Python = "python",
    NodeJS = "nodejs"
}
export declare enum SkillActionTypes {
    Logic = "logic",
    Dialog = "dialog"
}
export interface ActionParams {
    ...
    slots: {
        [key: string]: NLUSlot['value'] | undefined;
    };
    extra_context_data: {
        lang: ShortLanguageCode;
